...
const Settings = () => {
    ...
    const syncLibrary = async () => {
        ...
        await logToBackend('info', `syncLibrary button clicked - v${"1.1.9"}`);
        await logToBackend('info', '========================================');
        try {
            setSyncing(true);
